...
The following open source software packages are used for health economic decision modeling (aka, decision analysis) leveraging different frameworks: decision trees, Baynesian networks (eg, influence diagrams), mixed-integer linear programming (ie, optimization), and agent-based modeling.

1. R: [rdecision](https://cran.r-project.org/web/packages/rdecision/index.html): uses decision trees 
2. Python: [pyAgrum](https://pyagrum.gitlab.io/): uses influence diagrams
3. Julia: [DecisionProgramming.jl](https://gamma-opt.github.io/DecisionProgramming.jl/dev/): uses influence diagrams
4. Julia: [Agents.jl](https://juliadynamics.github.io/Agents.jl/stable/): uses agent-based modeling
...
4. Parnell, Gregory S, Terry A. Bresnick, Eric Specking, Steven N. Tani, and Eric R. Johnson. Handbook of Decision Analysis. 2nd ed. Wiley, 2025.
5. Arroyo, Paz, Annett Schöttle, and Randi Christensen. Building Decisions: How Choosing by Advantages Drives Project Success. Routledge, 2025. <https://doi.org/10.1201/9781003518310>.
6. Alastair Gray and Andrew Briggs, editors. Handbooks in Health Economic Evaluation. Oxford University Press. <https://www.herc.ox.ac.uk/downloads/handbooks-in-health-economic-evaluation> 
